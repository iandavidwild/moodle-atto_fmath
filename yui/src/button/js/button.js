...
Y.namespace('M.atto_fmath').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _getDialogueContent: function() {
        this._content = '<form class="atto_form">' +
        '<iframe id="editorIFrame" style="width:1000px;height:400px" src="' + M.cfg.wwwroot + '/lib/editor/atto/plugins/fmath/editor/onlyEditor.html"></iframe>' +
        '<div class="mdl-align">' +
            '<br/>' +
            '<button class="atto_fmath_submit">Save</button>' +
        '</div>' +
        '</form>';
